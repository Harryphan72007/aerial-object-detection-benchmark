...
| 13 | RT-DETRv2-L | rtdetr | Same | `rtdetr-<hash>/.../python` | Exact packages/CUDA/classes + pinned HF revision | Yes | PyTorch CUDA | Pinned `PekingU/rtdetr_v2_r50vd` | Diagnosed and repairable | Provision only when `START_HPO=True` |
